...
Msg("Ready to edit");
try {
const projectData = await fetchOne("project", Id);
if (projectData) {
...
const updatedProjectId = await updateOne("project", projectData);
console.log(`Project with id ${updatedProjectId} updated successfully.`);
