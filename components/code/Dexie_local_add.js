...
const AddPage = (tbl, fld) => {
  ...
  str = str + 'import {insertOne} from "../DexieDatabase";\n\n\n';
  ...
  str = str + 'try {\n';
  str = str + 'const new' + titleCase(tbl) + 'Data = create' + titleCase(tbl) + 'Object(); \n';
  str = str + ' await insertOne("' + tbl + '", new' + titleCase(tbl) + 'Data);\n';
  str = str + ' Msg("Data saved successfully.");\n';
  str = str + '} catch (error) {\n';
  str = str + ' console.log(`Error saving ' + tbl + ' data: ${error}`);\n';
  str = str + ' Msg("Error saving ' + tbl + ' data.");\n';
  str = str + '}\n';
