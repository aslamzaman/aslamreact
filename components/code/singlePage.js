...
const singlePage = (tbl, fld) => {
    ...
    str = str + 'import API_URL from "../../lib/API_URL";\n';
    str = str + '\n\n';
    ...
    str = str + 'let url_' + tbl + '_dropdown = API_URL + "' + tbl + '/dropdown";\n';
    ...
    str = str + 'let url_edit = API_URL + "' + tbl + '/edit/" + id;\n';
    ...
    str = str + 'save_url = API_URL + "' + tbl + '/save";\n';
    str = str + '} else {\n';
    str = str + 'save_url = API_URL + "' + tbl + '/update/" + updateId;\n';
    str = str + '}\n';
    ...
    str = str + 'let url_delete = API_URL + "' + tbl + '/delete/" + deleteId;\n';
    ...
    str = str + 'let url_view = API_URL + "' + tbl + '/view/" + id;\n';
