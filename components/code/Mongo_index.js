const MongoIndexPage = (tbl, fld) => {
  ...
  str = str + 'import {fetch' + titleCase(tbl) + '} from "../../components/Database";\n\n\n';
  ...
  str = str + ' try {\n';
  str = str + ' const response = await fetch' + titleCase(tbl) + '();\n';
  str = str + 'set' + titleCase(tbl) + 's(response);\n';
  str = str + ' } catch (error) {\n';
  str = str + 'console.error("Error fetching supplier:", err);\n';
  str = str + ' }\n';
  str = str + '}\n';
  str = str + 'fetchData();\n';
  str = str + '}, [msg]);\n\n\n';
  ...
  str = str + '<Add Data={' + tbl + 's} Msg={msgHandler} />\n';
  str = str + '<Print Data={' + tbl + 's} Msg={msgHandler} />\n';;
  str = str + '</th>\n';
  str = str + '</tr>\n';
  str = str + '</thead>\n';
  str = str + '<tbody>\n';
  ...
  str = str + '<Edit Data={' + tbl + 's} Msg={msgHandler} Id={' + tbl + '.id} />\n';
  str = str + '<Delete Data={' + tbl + 's} Msg={msgHandler} Id={' + tbl + '.id} />\n';
  str = str + '</td>\n';
  str = str + '</tr>\n';
  str = str + ')\n';
  str = str + '})\n';
