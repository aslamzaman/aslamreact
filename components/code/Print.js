                    ...
                    <div className="w-11/12 md:w-3/4 mx-auto mb-10 bg-white border-2 border-gray-300 rounded-md shadow-md duration-300">
                        ...
                        <div className="px-6 md:px-6 py-3 flex justify-between items-center border-b border-gray-300">
                            ...
                            <div className="flex justify-center items-center space-x-2">
                                ...
                                <button title="Close" onClick={closePrintForm} className="w-9 h-9 p-0.5 bg-gray-50 hover:bg-gray-300 rounded-md transition duration-500 cursor-pointer">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-full h-full stroke-black">
...
${td_string}                                                </tr>
            ...
            <button onClick={showPrintForm} title="Print" className="px-1 py-1 bg-blue-400 hover:bg-blue-600 rounded-md transition duration-500 cursor-pointer">
