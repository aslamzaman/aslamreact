...
const Edit = ({ Msg, Id }) => {
    ...
    const editHandler = () => {
        ...
        const getLocalData = editItem("bayprostabexecution", Id);
        ...
        if (getLocalData) {
            ...
            setNos(nos);
            setTaka(taka);
            setEng(taka==='0'?true:false);
            setCheck(taka==='0'?true:false);
            ...
            <div className={`fixed inset-0 py-16 bg-gray-900 ${show ? 'block' : 'hidden'}  bg-opacity-60 overflow-auto`}>
                <div className="w-11/12 md:w-8/12 mx-auto mb-10 bg-white border-2 border-gray-300 rounded-md shadow-md duration-300">
                    ...
                    <div className="flex items-center space-x-3">
						<input type="checkbox" onChange={()=>setEng(!eng)} checked={check} /> <p>English</p>
						</div>
