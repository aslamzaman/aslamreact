...
const Edit = ({ message, id, data }) => {
    ...
    const showEditForm = async () => {
        ...
        try {
            ...
            const { staffId, dt, cause, createdAt } = data;
            setStaffId(staffId);
            setDt(dt);
            setCause(cause);
    ...
    const saveHandler = async (e) => {
        ...
        try {
            ...
            const msg = await updateDataToFirebase("staffresign", id, newObject);
            message(msg);
        } catch (error) {
            console.error("Error saving staffresign data:", error);
            message("Error saving staffresign data.");
        } finally {
                        ...
                        <div className="px-6 pb-6 text-black">
                            <form onSubmit={saveHandler} >
                                <div className="grid grid-cols-1 gap-4 my-4">
                                    ...
                                    <TextEn Title="Cause" Id="cause" Change={e => setCause(e.target.value)} Value={cause} Chr={250} />
                                </div>
