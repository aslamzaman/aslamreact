...
import { BtnSubmit, DropdownEn, TextDt, TextEn, TextNum, TextareaEn } from "@/components/Form";

import { leaveJoin, leaveLeave, elTaka, effectiveJoinDate } from "./_lib/Calculation";
...
const Benefit = () => {
    ...
    const cmdCalculate = (e) => {
        e.preventDefault();
        const joinEffective = effectiveJoinDate(join,project);

        console.log(joinEffective);
        const dateDiff = dateDifferenceLocal(joinEffective, leave);
            ...
            <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <form onSubmit={cmdCalculate}>
                    <div className="w-full grid grid-cols-1 gap-3 border p-4">
                        <DropdownEn Title="Project" Change={e => setProject(e.target.value)} Value={project}>
