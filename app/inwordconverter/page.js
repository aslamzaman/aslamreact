...
import { TextEn, TextBn, TextNum, BtnEn, TextUn } from "@/components/Form";
...
const Inwordconverter = ({ Msg }) => {
    ...
    const resultHandler = () => {
        ...
        setInword_en(titleCamelCase(inwordEnglish(tk)));
    ...
    return (
        <>
            <div className="w-full lg:w-3/4 mx-auto mt-10 border-2 border-gray-300 rounded-md shadow-md">
                ...
                <div className="w-full p-4 overflow-auto">
                    <div className="grid grid-col-1 gap-y-4 mt-6">
                        ...
                        <TextBn Title="Inword Bangla" Id="inword_bn" Change={e => setInword_bn(e.target.value)} Value={inword_bn} Chr="150" />
                        <TextUn Title="Inword Unicode" Id="inword_un" Change={e => setInword_un(e.target.value)} Value={inword_un} Chr="150" />
                        <TextEn Title="Inword English" Id="inword_en" Change={e => setInword_en(e.target.value)} Value={inword_en} Chr="150" />
