...
const ConverterPage = () => {
    ...
    const [endDt, setEndDt] = useState(asLib.util.dateFormat(new Date(),"-"));
    ...
    const calculateDateHandler = () => {
        let x = asLib.util.manulalDateDiff(startDt, endDt);
    ...
    const calculateLandAreaHandler = () => {
        let result = asLib.util.landarea.result(area, opt);
        ...
        <div>
            ...
            <Modal size="lg" show={dateDiffModalShow} onHide={dateDiffModalCloseHandler}>
                ...
                <Modal.Footer>
                    ...
                    <Button variant="primary" onClick={calculateDateHandler}>Calculate</Button>
                </Modal.Footer>
            </Modal>
            ...
            <Modal size="lg" show={landAreaModalShow} onHide={landAreaModalCloseHandler}>
                <Modal.Header closeButton>
                    <Modal.Title>Land Area</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Form>
                        <Row className="mb-3">
