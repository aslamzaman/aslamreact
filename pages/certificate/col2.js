...
const Certificate = () => {
    ...
    const createPdfHanler = (e) => {
        ...
        setTimeout(() => {
            for (let i = 0; i < stdData.length; i++) {
                if (i > 0) {
                    doc.addImage("/images/certificate/Cirtificate_COL2.jpg", "JPG", 0, 0, 297, 210);
            ...
            doc.save(new Date().toISOString() + "-col-student-certificate.pdf");
    ...
    return (
        ...
        <Layout Title="Certificate COL-2">
            ...
            <div className="p-6">
                ...
                <div className="w-11/12 md:w-8/12 mx-auto my-[50px] flex flex-col items-center border border-gray-200 rounded-lg shadow-md bg-white z-50">
                    <div className="w-full bg-gray-100 border-b rounded-t-lg">
                        <h1 className="py-2.5 text-center font-semibold text-[calc(1.40rem+0.3vw)]">Certificate COL - 2</h1>
                    </div>
